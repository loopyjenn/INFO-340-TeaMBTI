...
import { isValid, getDaysInMonth, startOfMonth, getDay, subDays, getDate, getISODay, format, isSameDay, isSameMonth, addDays, min, max, isBefore, isAfter, getMonth, getYear, startOfDecade, endOfDecade, sub, subYears, add, addYears, setMonth, setYear, addMonths, differenceInSeconds, formatDistance } from "date-fns";
import FocusTrap from "focus-trap-react";
import getInitials from "name-initials";
import { generateColor } from "@marko19907/string-to-color";
import ellipsize from "ellipsize";
import keys$1 from "ctrl-keys";
...
const Portal = forwardRef(({ children, className, element = "div", onMount, onUnmount }, ref) => {
...
const CalendarDays = ({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        showDayOfWeek && /* @__PURE__ */ jsx("div", { className: twMerge(days.header), children: dayOfWeekLabels.map((day) => /* @__PURE__ */ jsx("div", { className: twMerge(days.dayOfWeek), children: day.substring(0, 2) }, `day-${day}`)) }),
        weeks.map((week, i) => /* @__PURE__ */ jsx("div", { className: twMerge(days.week), children: week.map(renderDay) }, `week-${i}`))
      ]
    },
    value.toString()
  ) });
...
const CalendarMonths = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: twMerge(months.root), children: monthNames.map((month, i) => /* @__PURE__ */ jsx(
    Button,
    {
    ...
    /* @__PURE__ */ jsxs("header", { className: twMerge(theme2.header.base), children: [
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          className: twMerge(theme2.header.prev),
          disablePadding: true,
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          className: twMerge(theme2.header.mid),
          disablePadding: true,
          fullWidth: true,
          children: /* @__PURE__ */ jsxs(SmallHeading, { disableMargins: true, className: twMerge(theme2.title), children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          className: twMerge(theme2.header.next),
          disablePadding: true,
          children: nextArrow
        }
      )
...
const JsonTreeNode = ({
  ...
  const renderPrimativeNode = useCallback(() => {
    ...
    return /* @__PURE__ */ jsxs(Fragment$1, { children: [
      ...
      /* @__PURE__ */ jsx("span", { className: twMerge(theme2.node.value), children: ellipsis && !isEmptyString ? /* @__PURE__ */ jsx(Ellipsis, { value: data.data, limit: ellipsisTextLength }) : valueLabel })
    ] });
...
const JsonTree = ({
  ...
  return /* @__PURE__ */ jsx("div", { tabIndex: -1, children: /* @__PURE__ */ jsx(Tree, { className, ...rest, children: /* @__PURE__ */ jsx(
    JsonTreeNode,
    {
      depth: 1,
      data: tree,
...
const CalendarRange = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: twMerge(theme2.base), children: [
    /* @__PURE__ */ jsxs("header", { className: twMerge(theme2.header.base), children: [
      ...
      /* @__PURE__ */ jsx(SmallHeading, { className: twMerge(theme2.title), disableMargins: true, children: displayMonths.map((i) => /* @__PURE__ */ jsx("span", { children: format(addMonths(viewValue, showPast ? -i : i), "MMMM") }, addMonths(viewValue, showPast ? -i : i).toDateString())) }),
      /* @__PURE__ */ jsxs(Stack, { children: [
        /* @__PURE__ */ jsx(
          Button,
          {
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode: "wait", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: twMerge(theme2.content), children: displayMonths.map((offset, idx) => /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
          CalendarDays,
          {
...
const Checkbox = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { className: twMerge(theme2.base, containerClassName), children: [
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...rest,
...
const CloseIcon = ({ height = 32, width = 32 }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    x: "0px",
...
const DotsLoader = ({
  ...
  return /* @__PURE__ */ jsx(motion.div, { className: twMerge(theme2.base, className), children: [...Array(3)].map((_, i) => /* @__PURE__ */ jsx(
    motion.div,
    {
      className: twMerge(theme2.dot, theme2.sizes[size]),
      animate: {
        opacity: [0, 1, 0],
        scale: [1, 2, 2, 1, 1]
      },
...
const SelectMenu = ({
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      style,
      className: twMerge(theme2.base, className, "select-menu"),
      initial: {
        opacity: 0,
        y: -20,
        pointerEvents: "none"
      ...
      children: /* @__PURE__ */ jsxs(List, { children: [
        ...
        groups.hasGroups ? groups.groups.map((g) => /* @__PURE__ */ jsx(Fragment, { children: g.name === "undefined" ? renderListItems(g.items, g) : /* @__PURE__ */ jsxs(
          ListItem,
          {
            className: twMerge(theme2.groupItem, "select-menu-group"),
            children: [
              /* @__PURE__ */ jsx(
                "h3",
                {
...
const Duration = ({ value, emptyValue = "N/A" }) => /* @__PURE__ */ jsx(Fragment$1, { children: formatDuration(value, emptyValue) });
...
const CommandPaletteInput = ({
  ...
  const inputRef = useRef(null);
  const handlerRef = useRef(keys$1());
...
const ColorBlock = ({ name, color: color2, className }) => /* @__PURE__ */ jsxs(
  "div",
  {
    style: {
...
const ColorPaletteBlock = ({
  ...
  const fontColor = valid && !name.includes("overlay") ? chroma(color2).luminance() >= 0.3 ? chroma(color2).darken(100).css() : chroma(color2).brighten(100).css() : "var(--body-color)";
  return /* @__PURE__ */ jsx(
    "div",
    {
      className,
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            typeof colors2 === "string" && /* @__PURE__ */ jsx(ColorBlock, { name: `${name}`, color: colors2, showName: showNames }),
            typeof colors2 === "object" && /* @__PURE__ */ jsx(Fragment$1, { children: Object.keys(colors2).map((color2) => /* @__PURE__ */ jsx(
              ColorPaletteBlock,
              {
                name: `${name}-${color2}`,
            ...
            typeof colors2 === "function" && /* @__PURE__ */ jsx(
              ColorBlock,
              {
                name: `${name}`,
                color: colors2({}),
...
const ColorBlocks = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: colors2 ? /* @__PURE__ */ jsx(Fragment$1, { children: Object.keys(colors2).map((key) => /* @__PURE__ */ jsx(ColorPaletteBlocks, { name: key, colors: colors2[key] }, key)) }) : /* @__PURE__ */ jsx("p", { children: "⚠️ No colors defined" })
    }
  );
};
...
const ComponentBlocks = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: components ? /* @__PURE__ */ jsx(Fragment$1, { children: Object.keys(components).map((key) => /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(
          "h3",
          {
            style: {
