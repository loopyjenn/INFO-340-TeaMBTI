...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("reablocks"), require("react"), require("ellipsize"), require("d3-array"), require("d3-shape"), require("d3-scale"), require("human-format"), require("transformation-matrix"), require("classnames"), require("memoize-bind"), require("react-cool-dimensions"), require("big-integer"), require("chroma-js"), require("react-fast-compare"), require("framer-motion"), require("d3-interpolate"), require("safe-identifier"), require("d3-geo"), require("d3-sankey"), require("@upsetjs/venn.js"), require("invert-color"), require("d3-hierarchy")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "reablocks", "react", "ellipsize", "d3-array", "d3-shape", "d3-scale", "human-format", "transformation-matrix", "classnames", "memoize-bind", "react-cool-dimensions", "big-integer", "chroma-js", "react-fast-compare", "framer-motion", "d3-interpolate", "safe-identifier", "d3-geo", "d3-sankey", "@upsetjs/venn.js", "invert-color", "d3-hierarchy"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.reaviz = {}, global.jsxRuntime, global.reablocks, global.react, global.ellipsize, global.d3Array, global.d3Shape, global.d3Scale, global.humanFormat, global.transformationMatrix, global.classNames, global.bind, global.useDimensions, global.bigInt, global.chroma, global.isEqual, global.framerMotion, global.d3Interpolate, global.safeIdentifier, global.d3Geo, global.d3Sankey, global.venn_js, global.invert, global.d3Hierarchy));
})(this, function(exports2, jsxRuntime, reablocks, react, ellipsize, d3Array, d3Shape, d3Scale, humanFormat, transformationMatrix, classNames, bind, useDimensions, bigInt, chroma, isEqual, framerMotion, d3Interpolate, safeIdentifier, d3Geo, d3Sankey, venn_js, invert, d3Hierarchy) {
  "use strict";
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Move,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("line", { className: css$s.line, y1: "0", y2: height, x1: "5", x2: "5" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "rect",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "g",
            {
              ...
              style: { pointerEvents: "none" },
              children: d3Array.range(5).map((i) => /* @__PURE__ */ jsxRuntime.jsx("circle", { cy: i * 5, cx: "5", r: ".5", className: css$s.dot }, i))
            }
          )
        ] })
      }
  ...
  const BrushSlice = (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("rect", { className: css$r.unsliced, height, width: start2 }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "rect",
        {
  ...
  const DiscreteLegendEntry = ({
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$n.label, children: label2 })
      ]
    }
  );
  ...
  const SequentialLegend = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$m.start, children: formatValue(start2) }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$m.end, children: formatValue(end2) })
        ]
      }
    );
  };
  ...
  const GridStripe = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("rect", { className: classNames(css$k.gridStripe, className), ...coords });
  };
  ...
  const TooltipTemplate = ({
    ...
    const renderValues = (data, index) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: css$i.subValue, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: css$i.subValueColor, style: { backgroundColor: fill } }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: css$i.subValueName, children: [
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, role: "tooltip", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: css$i.label, children: formatValue(value2.x) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: css$i.value, children: [
  ...
  const MotionPath = ({ custom, transition, ...rest }) => {
    ...
    const spring = framerMotion.useSpring(0, DEFAULT_TRANSITION);
    react.useEffect(() => {
  ...
  const useInterpolate$1 = ({ data, animated, arc }) => {
    ...
    const d = framerMotion.useMotionValue(exit);
    const spring = framerMotion.useSpring(0, DEFAULT_TRANSITION);
    react.useEffect(() => {
  ...
  const PieArc = ({
    ...
    const d = useInterpolate$1({ animated, arc, data });
    const [active, setActive] = react.useState(false);
    const fill = react.useMemo(
  ...
  const useInterpolate = ({ data, animated }) => {
    ...
    const spring = framerMotion.useSpring(0, { stiffness: 300, damping: 30 });
    react.useEffect(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: data.map((d, i) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("label", { title: label2, className: classNames(css$1.label, labelClassName), children: label2 }),
            renderBar(d, i),
            /* @__PURE__ */ jsxRuntime.jsx(
              "label",
              {
